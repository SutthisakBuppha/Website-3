  ...
  <body>
    <div class="container py-5">
      ...
      <div class="d-flex justify-content-end mb-3">
        <button id="backButton" class="btn btn-secondary d-none" onclick="fetchRecommendedRecipes()">กลับหน้าหลัก</button>
      </div>
    ...
    // ✅ ซ่อนปุ่มกลับ และรีเซ็ตช่องค้นหา
    backButton.classList.add('d-none');
    document.getElementById('query').value = ''; // <<< รีเซ็ตช่องกรอก
